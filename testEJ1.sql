...
CREATE TABLE LOCALIDAD(
  COD_LOCALIDAD  VARCHAR2(10) PRIMARY KEY,
NOMBRE VARCHAR2(10) NOT NULL
);

CREATE TABLE PUB_EMPLEADO(
  COD_PUB NUMBER(20) NOT NULL,
...
ADD CONSTRAINT CHK_PUBEMPLEADO CHECK (FUNCION='CAMARERO' OR FUNCION='SEGURIDAD' OR FUNCION='LIMPIEZA');
